...
def _kwargs():
    return {
        ...
        "protection_uncertainty_summary": "diagnostic only",
        "started_at_ns": T0,
        "ended_at_ns": T0,
        "venue_observations_obtained": True,
        "venue_evidence_refs": ("query-1",),
...
def test_recovery_ready_requires_positive_flat_or_current_protection_evidence():
    ...
    with_flat = run_recovery(**_kwargs(), protection_evidence=RecoveryProtectionEvidence(True, False, ("flat-cert-1",)))
