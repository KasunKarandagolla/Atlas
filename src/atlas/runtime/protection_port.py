...
class BybitProtectionPortUnavailable:
    def _x(self):
        raise RuntimeError("TEST GATE: authenticated Bybit protection port unavailable")

    def read_protection(self, *a, **k):
        return self._x()

    def ensure_full_stop(self, *a, **k):
        return self._x()

    def read_economic_events(self, *a, **k):
        return self._x()
