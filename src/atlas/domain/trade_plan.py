...
class TradePlan:
    ...
    def __post_init__(self) -> None:
        ...
        ensure_positive_decimal(self.qty_limit, field="qty_limit")
        ensure_decimal(self.collar, field="collar")
        ensure_decimal(self.stop, field="stop")
        ensure_decimal(self.normal_risk, field="normal_risk")
        ensure_decimal(self.stress_risk, field="stress_risk")
        ensure_decimal(self.margin, field="margin")
        ensure_decimal(self.leverage_bound, field="leverage_bound")
        if self.qty_limit <= 0:
