...
def initial_unverified_fixture(
    *,
    ...
    installed_artifact_sha256: str = "eab45fafd2312deda1236554c49a9798bfc76bc8465af864878e2f70189ebebe",
    dependency_lock_sha256: str = "f96c2a44760f1dd95f05b93857afab4af9a8cb5554a69f56b82e8e7ac09f0a54",
    python_platform_abi: str = "cpython-312-x86_64-linux-gnu",
    product: str = "linear",
