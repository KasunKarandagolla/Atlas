...
def candidate_trade_plan(*, plan_id: str, snapshot: FeatureSnapshot, policy: FixedPolicy, policy_hash: str,
                         ...
                         cost_evidence_ref: str, account_scope: str, market: str = "BYBIT_LINEAR_USDT") -> TradePlan:
    ...
    return TradePlan(
        ...
        account_scope=account_scope, instrument=snapshot.instrument, side=policy.side, qty_limit=policy.quantity,
